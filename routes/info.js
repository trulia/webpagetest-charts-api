...
const debug = require("debug")("wpt-api:info");

router.get("/", function(req, res, next) {
  const data = {
    availableEndpoints: {
      "/run_tests/:suiteName":
        "Manually run the tests. Don't abuse, WPT is sensitive",
      ...
      "/tests/:suiteName/:testName":
        "Get aggregated data for a test within a suite, and links to the tests within. A lot of data.",
